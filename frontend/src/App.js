...
const contractAddress = '0x1299DBf88e16345004f7fc16b2D87f735ee1DeC1';
const contractAbi = [ 
  {
    "inputs": [],
...
function App() {
  ...
  const mintTokens = async () => {
    ...
    try {
      ...
      // Use `parseUnits` instead of `BigNumber`
      const value = parseUnits(amount, 14); // Adjust decimals if necessary
